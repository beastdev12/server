...
data modify block ~ ~ ~ Items[{Slot:8b}].tag.StoredEnchantments[] set from block ~ ~ ~ Items[{Slot:3b}].tag.Enchantments[-1]
data modify block ~ ~ ~ Items[{Slot:5b}].id set value "minecraft:air"

# Remove the Bottom-Most Enchantment from the Item
data remove block ~ ~ ~ Items[{Slot:3b}].tag.Enchantments[-1]
