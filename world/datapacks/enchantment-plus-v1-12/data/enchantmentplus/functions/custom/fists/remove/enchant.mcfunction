...
function enchantmentplus:custom/fists/remove/lore_loop
...
# Remove Tag
data remove block ~ ~ ~ Items[{Slot:3b}].tag.Fists
data remove block ~ ~ ~ Items[{Slot:3b}].tag.AttributeModifiers[{Name:"enchantmentplus:generic.attack_damage"}]
