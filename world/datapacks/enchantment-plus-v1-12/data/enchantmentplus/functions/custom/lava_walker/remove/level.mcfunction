# Decrease Level
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{LavaWalker:1b} run data remove block ~ ~ ~ Items[{Slot:3b}].tag.LavaWalker
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{LavaWalker:2b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.LavaWalker set value 1b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{LavaWalker:3b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.LavaWalker set value 2b
...
function enchantmentplus:custom/lava_walker/remove/lore_level
