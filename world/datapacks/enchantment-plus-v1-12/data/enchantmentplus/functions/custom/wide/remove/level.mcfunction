# Decrease Level
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Wide:1b} run data remove block ~ ~ ~ Items[{Slot:3b}].tag.Wide
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Wide:2b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Wide set value 1b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Wide:3b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Wide set value 2b
...
function enchantmentplus:custom/wide/remove/lore_level
