# Decrease Level
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Leaping:1b} run data remove block ~ ~ ~ Items[{Slot:3b}].tag.Leaping
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Leaping:2b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Leaping set value 1b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Leaping:3b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Leaping set value 2b
...
function enchantmentplus:custom/leaping/remove/lore_level
