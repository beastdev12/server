...
function enchantmentplus:custom/traveler/remove/lore_loop
...
# Remove Tag
data remove block ~ ~ ~ Items[{Slot:3b}].tag.Traveler
data remove block ~ ~ ~ Items[{Slot:3b}].tag.AttributeModifiers[{Name:"enchantmentplus:generic.movement_speed"}]
