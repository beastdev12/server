...
function enchantmentplus:custom/healthboost/remove/lore_loop
...
# Remove Tag
data remove block ~ ~ ~ Items[{Slot:3b}].tag.HealthBoost
data remove block ~ ~ ~ Items[{Slot:3b}].tag.AttributeModifiers[{Name:"enchantmentplus:generic.max_health"}]
