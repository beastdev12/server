# Decrease Level
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Deflect:1b} run data remove block ~ ~ ~ Items[{Slot:3b}].tag.Deflect
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Deflect:2b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Deflect set value 1b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Deflect:3b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Deflect set value 2b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Deflect:4b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Deflect set value 3b
...
function enchantmentplus:custom/deflect/remove/lore_level
