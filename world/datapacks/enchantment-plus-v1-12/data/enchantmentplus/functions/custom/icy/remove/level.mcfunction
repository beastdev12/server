# Decrease Level
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Icy:1b} run data remove block ~ ~ ~ Items[{Slot:3b}].tag.Icy
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Icy:2b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Icy set value 1b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Icy:3b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Icy set value 2b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Icy:4b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Icy set value 3b
execute if data block ~ ~ ~ Items[{Slot:3b}].tag{Icy:5b} run data modify block ~ ~ ~ Items[{Slot:3b}].tag.Icy set value 4b
...
function enchantmentplus:custom/icy/remove/lore_level
